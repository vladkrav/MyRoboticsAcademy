...
class Commands:
    ...
    def get_ros_instructions(self, exercise, circuit=None):
        if ACCELERATION_ENABLED:
            roslaunch_cmd = '/bin/sh -c "export PWD="/";export DISPLAY=:0;export VGL_DISPLAY=/dev/dri/card0;export OLDPWD=/etc/ros/rosdep;export LD_LIBRARY_PATH=/opt/ros/melodic/lib:/usr/lib/x86_64-linux-gnu/gazebo-9/plugins:/catkin_ws/devel/lib;export GAZEBO_MODEL_PATH=/usr/share/gazebo-9/models:$GAZEBO_MODEL_PATH;export GAZEBO_MODEL_DATABASE_URI=http://gazebosim.org/models;export ROS_DISTRO=melodic;export PKG_CONFIG_PATH=/opt/ros/melodic/lib/pkgconfig;export OGRE_RESOURCE_PATH=/usr/lib/x86_64-linux-gnu/OGRE-1.9.0;export SHLVL=1;export GAZEBO_PLUGIN_PATH=/usr/lib/x86_64-linux-gnu/gazebo-9/plugins:${GAZEBO_PLUGIN_PATH};export TERM=xterm;export ROS_VERSION=1;export GAZEBO_MASTER_URI=http://localhost:11345;ROS_ETC_DIR=/opt/ros/melodic/etc/ros;export CMAKE_PREFIX_PATH=/opt/ros/melodic;export ROS_PACKAGE_PATH=/opt/ros/melodic/share; export' \
                ...
                'export ROS_PACKAGE_PATH=/opt/ros/melodic/share:/PX4-Autopilot:/PX4-Autopilot/Tools/sitl_gazebo:/catkin_ws/src/drone_wrapper:/catkin_ws/src/drone_assets;'
        else:
            roslaunch_cmd = '/bin/sh -c "export PWD="/";export DISPLAY=:0;export OLDPWD=/etc/ros/rosdep;export LD_LIBRARY_PATH=/opt/ros/melodic/lib:/usr/lib/x86_64-linux-gnu/gazebo-9/plugins:/catkin_ws/devel/lib;export GAZEBO_MODEL_PATH=/usr/share/gazebo-9/models:$GAZEBO_MODEL_PATH;export GAZEBO_MODEL_DATABASE_URI=http://gazebosim.org/models;export ROS_DISTRO=melodic;export PKG_CONFIG_PATH=/opt/ros/melodic/lib/pkgconfig;export OGRE_RESOURCE_PATH=/usr/lib/x86_64-linux-gnu/OGRE-1.9.0;export SHLVL=1;export GAZEBO_PLUGIN_PATH=/usr/lib/x86_64-linux-gnu/gazebo-9/plugins:${GAZEBO_PLUGIN_PATH};export TERM=xterm;export ROS_VERSION=1;export GAZEBO_MASTER_URI=http://localhost:11345;ROS_ETC_DIR=/opt/ros/melodic/etc/ros;export CMAKE_PREFIX_PATH=/opt/ros/melodic;export ROS_PACKAGE_PATH=/opt/ros/melodic/share; export' \
                'PYTHONPATH=/opt/ros/melodic/lib/python3/dist-packages/; export' \
                'ROS_ROOT=/opt/ros/melodic/share/ros;export GAZEBO_RESOURCE_PATH=/usr/share/gazebo-9:$GAZEBO_RESOURCE_PATH; export' \
                'ROS_MASTER_URI=http://localhost:11311;export PATH=/opt/ros/melodic/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin;' \
                'export ROS_PACKAGE_PATH=/opt/ros/melodic/share:/PX4-Autopilot:/PX4-Autopilot/Tools/sitl_gazebo:/catkin_ws/src/drone_wrapper:/catkin_ws/src/drone_assets;'
    ...
    def start_vnc(self, display, internal_port, external_port):
        if not (ACCELERATION_ENABLED):
            ...
            novnc_cmd = f"/home/vlad/TFM/noVNC/utils/launch.sh --listen {external_port} --vnc localhost:{internal_port}"
    ...
    def start_exercise(self, exercise, circuit=None):
        ...
        try:
            ...
            while not server_ready:
                try:
                    f = open("/home/vlad/logs/ws_code_guest.log", "r")
        ...
        try:
            ...
            while not server_ready:
                try:
                    f = open("/home/vlad/logs/ws_gui_guest.log", "r")
    ...
    async def kill_all(self):
        ...
        cmd_melodic = cmd + ['melodic']
        self.call_subprocess(cmd_melodic)
        cmd_px4 = cmd + ['px4']
        self.call_subprocess(cmd_px4)
        # Remove previous exercise ws startup logs
        try:
            self.call_subprocess(['rm', '/home/vlad/logs/ws_code.log'])
        except:
            pass
        try:
            self.call_subprocess(['rm', '/home/vlad/logs/ws_gui.log'])
        except:
            pass
        try:
            self.call_subprocess(['rm', '/home/vlad/logs/ws_code_guest.log'])
        except:
            pass
        try:
            self.call_subprocess(['rm', '/home/vlad/logs/ws_gui_guest.log'])
        except:
            pass
...
class Manager:
    ...
    def evaluate_code(self, code, warnings=False):
        try:
            ...
            command = "export PYTHONPATH=$PYTHONPATH:/home/vlad/TFM/RoboticsAcademy/exercises/static/exercises/{}/web-template; python3 pylint_checker.py".format(self.exercise)
